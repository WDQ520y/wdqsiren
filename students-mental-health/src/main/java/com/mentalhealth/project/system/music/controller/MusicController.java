...
public class MusicController extends BaseController
{
    ...
    private static final String VIRTUAL_FILE_PATH = "/music/";
    ...
    public AjaxResult remove(String ids)
    {
        ...
        Music music = new Music();
            ...
            return "<script>parent.layer.close(parent.layer.getFrameIndex(window.name));parent.$.table.refresh();</script>";
        }
